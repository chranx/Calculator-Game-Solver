...
{
	@FXML Button button;
	@FXML TextArea answer_text;
	@FXML TextField moves_int;
	@FXML TextField possible_text;
	@FXML TextField start_int;
	@FXML TextField goal_int;

	@FXML
	public void press(ActionEvent e)
	{
		int start = Integer.parseInt(start_int.getText());
		int moves = Integer.parseInt(moves_int.getText());
		int goal = Integer.parseInt(goal_int.getText());
		String finalAnswer = "";

		String poss = possible_text.getText();
		...
		while(answer > 0)
		{
			if(count > 0)
			{
				finalAnswer += possible.get((answer%10) - 1) + "  ";
				count--;
			}
			else
			{
				finalAnswer += "\n" + possible.get((answer%10) - 1) + "  ";
				count = 4;
			}
		...
		answer_text.setText(finalAnswer);
